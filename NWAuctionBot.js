// ==UserScript==
// @name           Neverwinter Gateway - Auction Seller Bot
// @description    Automatically sell trash items
// @namespace      https://github.com/AlexeySch/Auction/blob/master/
...
(function() {
    ...
    for (var i = 0; i < settingnames.length; i++) {
        ...
        if (typeof(settingnames[i].onsave) === "function") {
            console.log("Calling11 'onsave' for", settingnames[i].name);
...
function GetCharName(){return unsafeWindow.client.dataModel.model&&unsafeWindow.client.dataModel.model.ent&&unsafeWindow.client.dataModel.model.ent.main?unsafeWindow.client.dataModel.model.ent.main.name+"@"+unsafeWindow.client.dataModel.model.ent.main.publicaccountname:undefined}
...
function process() {
    ...
    //console.log("dfdNextRun.done(function(delayTimer)");
...
function loginProcess() {
    ...
    if (accountName) {
        ...
        //console.log ("FullName= "+fullCharName);
        //            console.log (GetCharName());//unsafeWindow.client

        if (unsafeWindow.client.getCurrentCharAtName() != fullCharName) {
            loadCharacter(fullCharName);
            return;
        }
        //console.log ("processCharacter");
        // Try to start tasks
...
function SaveSettings() {
    ...
    for (var i = 0; i < settingnames.length; i++) {
        ...
        if (typeof(settingnames[i].onsave) === "function") {
            console.log("Calling1 'onsave' for", name);
